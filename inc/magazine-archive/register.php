...
require_once HSE_CHILD_DIR . 'inc/magazine-archive/helpers.php';

add_action( 'elementor/widgets/register', function ( $widgets_manager ) {
	require_once HSE_CHILD_DIR . 'inc/magazine-archive/widget.php';
...
add_action( 'wp_enqueue_scripts', function () {
	wp_register_style(
		...
		get_stylesheet_directory_uri() . '/inc/magazine-archive/assets/magazine-archive.css',
		[],
		defined( 'ASTRA_THEME_VERSION' ) ? ASTRA_THEME_VERSION : false
	);
	wp_register_script(
		'magazine-archive-script',
		get_stylesheet_directory_uri() . '/inc/magazine-archive/assets/magazine-archive.js',
		[ 'elementor-frontend' ],
		defined( 'ASTRA_THEME_VERSION' ) ? ASTRA_THEME_VERSION : false,
		true
	);
